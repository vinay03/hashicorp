...
# Network Security Group (NSG) for DB Tier Subnet
...
# Connect NSG and Subnet
resource "azurerm_subnet_network_security_group_association" "db_subnet_nsg_connection" {
...
## NSG Inbound Rule for DB Tier Subnet
